...
class TestViewContainerRef extends ViewContainerRef {
  ...
  createEmbeddedView<C>(
    ...
    context?: C, index?: number): import('@angular/core'
  ).EmbeddedViewRef<C> {
    throw new Error('Method not implemented.');
  }
  createComponent<C>(
    componentFactory: import('@angular/core').ComponentFactory<C>,
    index?: number, injector?: import('@angular/core').Injector,
...
describe('ContainerRefDirective', () => {
  it('should create an instance', () => {
    const directive = new ContainerRefDirective(new TestViewContainerRef());
